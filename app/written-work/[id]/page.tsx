  ...
  return (
    <div className="min-h-screen flex flex-col bg-gradient-to-br from-gray-900 via-blue-950 to-gray-900 text-white"> 
      ...
      <div className="p-6 mx-auto mt-24">
        <div className="md:w-[70vw] w-[95vw] bg-white/80 backdrop-blur-lg rounded-2xl shadow-2xl p-8 border border-gray-200 animate-in fade-in slide-in-from-bottom duration-700">
          {/* Title & Date */}
          ...
          <div className="flex justify-between items-center mt-10 text-sm md:text-lg gap-x-2">
            ...
            <Link
              href="/written-work"
              className="px-5 py-3 rounded-xl md:rounded-full bg-gradient-to-r from-blue-500 to-indigo-500 text-white shadow-md hover:shadow-xl hover:scale-105 transition-transform"
            >
