        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <Link href="/multimedia" className="block">
              <Card className="cursor-pointer group hover:shadow-2xl transition-all duration-500 hover:-translate-y-3 border-l-4 border-orange-500 overflow-hidden animate-in fade-in slide-in-from-bottom duration-700 delay-200 bg-white">
            ...
            <Link href="/social-media" className="block">
              <Card className="cursor-pointer group hover:shadow-2xl transition-all duration-500 hover:-translate-y-3 border-l-4 border-purple-500 overflow-hidden animate-in fade-in slide-in-from-bottom duration-700 delay-400 bg-white">
                <div className="aspect-video relative overflow-hidden">
                  <Image
            ...
            <Link href="/written-work" className="block">
              <Card className="cursor-pointer group hover:shadow-2xl transition-all duration-500 hover:-translate-y-3 border-l-4 border-emerald-500 overflow-hidden animate-in fade-in slide-in-from-bottom duration-700 delay-600 bg-white">
                <div className="aspect-video relative overflow-hidden">
                  <Image
