...
export default function WorkPage() {
  return (
    <div className="min-h-screen bg-gradient-to-b from-[#0a1724] via-[#0f1d2e] to-[#0a1724] text-white">
      ...
      <section className="pt-32 pb-20 px-6 text-center">
        <div className="max-w-4xl mx-auto animate-in fade-in slide-in-from-bottom duration-700">
          <h1 className="text-5xl lg:text-6xl font-extrabold leading-tight mb-6">
            My <span className="text-transparent bg-clip-text bg-gradient-to-r from-emerald-400 to-teal-300">Work</span>
          </h1>
      ...
      {/* Divider */}
      <div className="w-full h-[2px] bg-gradient-to-r from-transparent via-emerald-500 to-transparent mb-20 opacity-60"></div>
      ...
      <section className="max-w-6xl mx-auto px-6 pb-24">
        <div className="grid md:grid-cols-3 gap-10">
          ...
          <Link href="/multimedia" className="block">
            <Card className="group bg-[#111827] border border-gray-700 hover:shadow-2xl hover:border-emerald-500 transition-all duration-500 rounded-2xl overflow-hidden">
