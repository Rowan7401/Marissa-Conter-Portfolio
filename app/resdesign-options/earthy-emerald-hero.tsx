  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-emerald-950 to-slate-800 text-white relative overflow-hidden">
      ...
      <div className="absolute inset-0">
        {/* Organic shapes */}
        <div className="absolute top-32 -left-20 w-96 h-96 bg-gradient-to-r from-emerald-500/20 to-teal-500/20 rounded-full blur-3xl transform rotate-12"></div>
        <div className="absolute bottom-20 right-10 w-80 h-80 bg-gradient-to-r from-red-900/15 to-amber-900/15 rounded-full blur-3xl"></div>
        <div className="absolute top-1/3 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-96 h-96 bg-gradient-to-r from-teal-600/10 to-emerald-600/10 rounded-full blur-3xl transform -rotate-45"></div>
      </div>
      ...
      <nav className="relative z-20 p-6">
        <div className="flex justify-between items-center">
          ...
          <div className="hidden md:flex space-x-8 text-emerald-100 font-serif">
          ...
          <div className="grid lg:grid-cols-5 gap-12 items-center">
            ...
            <div className="relative lg:col-span-2 order-2 lg:order-1 flex justify-center">
              <div className="relative group">
                ...
                <div className="relative w-80 h-[480px] lg:w-96 lg:h-[520px]">
                  ...
                  <div className="absolute -top-4 -left-4 w-8 h-8 border-l-4 border-t-4 border-green-800"></div>
                  <div className="absolute -top-4 -right-4 w-8 h-8 border-r-4 border-t-4 border-green-800"></div>
                  <div className="absolute -bottom-4 -left-4 w-8 h-8 border-l-4 border-b-4 border-green-800"></div>
                  <div className="absolute -bottom-4 -right-4 w-8 h-8 border-r-4 border-b-4 border-green-800"></div>
                  
                  <div className="relative w-full h-full rounded-lg overflow-hidden shadow-2xl ring-1 ring-emerald-700/50 group-hover:ring-emerald-600/70 transition-all duration-500">
                    <Image
                    ...
                    />
                    {/* Vintage overlay */}
                    <div className="absolute inset-0 bg-gradient-to-b from-transparent via-transparent to-emerald-950/20"></div>
                  </div>
                </div>

                {/* Vintage quote element */}
                <div className="absolute -bottom-8 -right-6 bg-gradient-to-r from-green-900 to-green-800 text-emerald-50 px-4 py-2 rounded transform rotate-3 shadow-xl border border-emerald-700/50">
            ...
            <div className="space-y-8 order-1 lg:order-2 lg:col-span-3">
              ...
              <div className="space-y-2">
                <h1 className="font-serif text-6xl md:text-7xl lg:text-8xl font-normal font-black bg-gradient-to-r from-emerald-300 via-teal-200 to-emerald-400 bg-clip-text text-transparent leading-tight">
                  Marissa
                </h1>
                <h1 className="font-serif text-6xl md:text-7xl lg:text-8xl font-normal font-black bg-gradient-to-r from-emerald-300 via-teal-200 to-emerald-400 bg-clip-text text-transparent leading-tight">
                  Conter
                ...
                <div className="flex items-center gap-4 pt-4">
                  <div className="w-16 h-0.5 bg-gradient-to-r from-emerald-600/30 to-teal-600/30 backdrop-blur-sm"></div>
                  <div className="w-2 h-2 bg-gradient-to-r from-emerald-600/30 to-teal-600/50 backdrop-blur-sm rounded-full"></div>
                  <div className="w-24 h-0.5 bg-gradient-to-r from-emerald-600/30 to-teal-600/30 backdrop-blur-sm"></div>
                </div>
              </div>

              {/* Specialty areas with vintage newspaper style */}
              <div className="space-y-6">
                <h3 className="font-serif text-2xl text-emerald-200 mb-4 italic">Areas of Expertise</h3>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="bg-gradient-to-r from-emerald-600/30 to-teal-600/30 backdrop-blur-sm p-5 border-l-4 border-green-700 shadow-lg">
                    <h4 className="font-serif text-xl text-emerald-200 font-semibold">Crime Reporting</h4>
                    <p className="text-amber-200/80 text-sm mt-1 font-serif">In-depth criminal justice coverage</p>
                  </div>
                  <div className="bg-gradient-to-r from-emerald-600/30 to-teal-600/50 backdrop-blur-sm p-5 border-l-4 border-white-700 shadow-lg">
                    <h4 className="font-serif text-xl text-emerald-200 font-semibold">Court Proceedings</h4>
                    <p className="text-amber-200/80 text-sm mt-1 font-serif">Legal system analysis & reporting</p>
                  </div>
                  <div className="bg-gradient-to-r from-emerald-600/30 to-teal-600/30 backdrop-blur-sm p-5 border-l-4 border-green-700 shadow-lg">
                    <h4 className="font-serif text-xl text-emerald-200 font-semibold">Public Safety</h4>
                    <p className="text-amber-200/80 text-sm mt-1 font-serif">Community safety & emergency response</p>
                  </div>
                  <div className="bg-gradient-to-r from-emerald-600/30 to-teal-600/50 backdrop-blur-sm p-5 border-l-4 border-white-700 shadow-lg">
                    <h4 className="font-serif text-xl text-emerald-200 font-semibold">Local Features</h4>
              ...
              <div className="bg-gradient-to-r from-emerald-600/30 to-teal-600/30 backdrop-blur-sm rounded-lg p-6 border border-amber-700/30 shadow-2xl">
                <div className="text-center border-b border-emerald-700/50 pb-4 mb-4">
                  <h2 className="font-serif text-3xl text-emerald-100  font-bold">STAFF REPORTER</h2>
                  <div className="flex items-center justify-center gap-2 mt-2">
                    <div className="w-8 h-0.5 bg-green-800"></div>
                    <div className="w-2 h-2 bg-emerald-700 rounded-full"></div>
                    <div className="w-8 h-0.5 bg-green-800"></div>
                  </div>
                </div>
                <div className="text-center space-y-2">
                  <a href="https://www.kitsapsun.com/" className="font-serif text-2xl font-bold text-green-300 hover:text-green-200 transition-colors block">
                    The Kitsap Sun
                  </a>
